...
INSERT INTO `Cinema` VALUES (1,'Красный кирпич','ул. Кирпичная дом 3'),(2,'лол','ул.шипиловская'),(3,'(----___----)','ух какя улица'),(34,'',''),(35,'','');
...
INSERT INTO `Country` VALUES ('Россия',1),('США',2);
...
CREATE TABLE `Film` (
  ...
  CONSTRAINT `R_1` FOREIGN KEY (`number_country`) REFERENCES `Country` (`number_country`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `Film` VALUES (1,'Пупок 3',116,1),(3,'=-)',123,1);
...
CREATE TABLE `Session` (
  ...
  CONSTRAINT `R_2` FOREIGN KEY (`number_film`) REFERENCES `Film` (`number_film`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `R_3` FOREIGN KEY (`number_type`) REFERENCES `Type_Session` (`number_type`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `R_4` FOREIGN KEY (`number_cinema`) REFERENCES `Cinema` (`number_cinema`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `Session` VALUES (1,1,1,1,4,'2017-04-13 09:09:00'),(12,8,3,3,7,'2017-04-22 16:17:00');
...
INSERT INTO `Type_Session` VALUES (7,'-\\(-_-)/-'),(4,'2D'),(5,'3D'),(6,'5D'),(1,'IMAX');
...
-- Dump completed on 2017-04-17 10:44:40
